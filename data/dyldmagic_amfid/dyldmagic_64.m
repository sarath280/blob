 ...
 */
    ...
    dy_cmd.cmdsize = sizeof(struct dylib_command) + strlen("KimJongCracks.dylib") + 0x10;
    ...
    strcpy(buf + mh.sizeofcmds + sizeof(mh) + sizeof(struct dylib_command), "KimJongCracks.dylib");
